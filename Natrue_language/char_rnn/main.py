...
class CharRNNTrainer(Trainer):
    ...
    def train(self, train_data):
        ...
        for data in tqdm(train_data):
            ...
            self.metric_meter['loss'].add(loss.item())
    ...
    def test(self):
        ...
        """
        self.model.eval()
        begin = np.array([i for i in '天青色等烟雨'])
    ...
    def fit(self, train_data):
        ...
        for e in range(1, opt.max_epoch + 1):
            ...
            train_str = self.train(train_data)
            test_str = self.test()
...
def train(**kwargs):
    ...
    char_rnn_trainer.model = get_model(convert)
    #char_rnn_trainer.load_state_dict('./checkpoints/CharRNN-0728233406.pth')
    char_rnn_trainer.criterion = get_loss
